...
class StreamTools:
    ...
    def check_if_process_running(self, process):
        ...
        if process.pid is not None:
            result = 'Control Center is running with PID ' + process.pid
        else:
    ...
    def start_controlcenter(self):
        ...
        controlcenter = subprocess.Popen(['py', 'streamtools_controlcenter.py'])
        controlcenter_process = ST_Process(controlcenter.pid, 'Control Center is running with PID ' + str(controlcenter.pid), 'streamtools_controlcenter.py', controlcenter)
        self.cc_status_label.configure(text = "StreamTools Control Center Status: " + str(controlcenter_process.status))
    ...
    def update_status_label(self,process):
        ...
        self.cc_status_label = tk.Label(text="StreamTools Control Center Status: " + str(process.status))
